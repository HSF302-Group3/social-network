...
""")
    List<Post> findAllByUsercreateAndActiveAndCreatedAtOrderByCreatedAtDesc(Users usercreate, boolean active);
    ...
    @Query("""
                       select p from Post p where    p.active = true 
            ...
            """)
    List<Post> getPostOfFriend(Users user);
}
